...
const ALGO_META = {
  DQN: {
    ...
    architecture: '3-layer MLP (451→64→64→3) · ReLU · ε-greedy · AdamW',
    bestFor:      'Trending markets with clear directional momentum',
    trainNote:    '2 000 episodes · random-start · continuous P&L reward',
  ...
  DDQN: {
    ...
    architecture: 'Dual MLP (online + target) · Decoupled argmax · hard target sync',
    bestFor:      'Mixed-trend markets where DQN overbets',
    trainNote:    '2 000 episodes · same env as DQN · target copy every 10 episodes',
  ...
  A2C: {
    ...
    architecture: 'Shared trunk (451→256→256) → actor + critic heads · action masking',
    bestFor:      'Volatile markets where value-based methods oscillate',
    trainNote:    '3 000 episodes · advantage-normalised · entropy annealed 0.05→0.005',
  ...
  PPO: {
    ...
    architecture: 'Actor-Critic (451→256→256) · clipped ratio ε=0.2 · action masking',
    bestFor:      'General deployment — most reliable in unseen regimes',
    trainNote:    '3 000 episodes · clip=0.2 · 4 epochs/rollout · advantage-normalised',
